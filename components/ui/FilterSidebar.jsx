...
/**
 * filterDefs: [
 *   { name: 'Marcas', key: 'brand', options: ['Yamaha','Martin',...] },
 *   { name: 'Subcategorías', key: 'subcategory', options: ['Alto','Tenor',...] },
 *   // puedes añadir más bloques: { name: 'Otra', key: 'otra', options: [...] }
 * ]
 * filterQuery: objeto con arrays por clave, ej. { brand: ['Yamaha'], subcategory: ['Alto'] }
 */
